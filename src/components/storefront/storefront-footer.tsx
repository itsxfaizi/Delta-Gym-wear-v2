...
export const StorefrontFooter = forwardRef<HTMLElement, HTMLAttributes<HTMLElement>>(function StorefrontFooter(props, ref) {
  return (
    <footer {...props} ref={ref} id="contact" className="site-footer">
      ...
      <nav aria-label="Support links"><strong>Support</strong><Link href="/#contact">Contact Us</Link><span>Sizing Guide</span><span>Returns</span><span>FAQs</span></nav>
      <span className="footer-watermark" aria-hidden="true">Delta</span>
